...
function Player:update(dt)
    ...
    self.object.transform.position = self.object.transform.position + vector.new(moveForward, moveSideways)
    self.object.transform.rotation = self.object.transform.rotation + rotate
    self.object.player.zoom = self.object.player.zoom + zoom

    display:moveCamera(-self.object.transform.position.x, -self.object.transform.position.y)
